...
const About = () => {
  return (
    <div>
      <div
        name="about"
        className="w-full h-screen bg-[#0a192f] text-gray-300 -mt-8 "
      >
        <div className="flex flex-col justify-center items-center w-full h-full p-10">
          ...
          <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
            <div className="lg:text-4xl sm:text-right text-3xl  font-bold">
              <p>
                Hi. I'm Omer Faruq, nice to meet you. Please take a look around.
              </p>
            </div>
            <div>
              <p>
